...
final allWorkersProvider = FutureProvider<List<Map<String, dynamic>>>((
  ref,
) async {
  ...
  for (final profile in profilesData) {
    ...
    // Skip workers without worker_profiles
...
class AllWorkersPage extends ConsumerWidget {
  const AllWorkersPage({super.key});
                            ...
                            Wrap(
                              ...
                              children: allJobs.map((job) {
                                ...
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isPrecargado
                                        ? AppTheme.clientPrimary.withValues(
                                            alpha: 0.15,
                                          )
