...
class CategoryWorkersPage extends ConsumerWidget {
  final String categoryName;

  const CategoryWorkersPage({super.key, required this.categoryName});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final categoryWorkers = state.featuredWorkers
        .where(
          (worker) =>
              worker.profession.toLowerCase() == categoryName.toLowerCase(),
        )
        .toList();
