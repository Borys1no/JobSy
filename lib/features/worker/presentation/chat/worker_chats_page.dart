...
class WorkerChatsPage extends ConsumerWidget {
  const WorkerChatsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(workerChatControllerProvider);
  ...
  Widget _buildChatItem(
    ...
    final isMeWorker = chat.workerId == userId;

    final displayName = isMeWorker ? chat.clientName : chat.workerName;
    final displayAvatar = isMeWorker ? chat.clientAvatar : chat.workerAvatar;
